...
class guest extends Controller
{
    ...
    public function purchase($key,$value = 0)
    {
    	switch ($key) {
 			...
 			case '1':
 				...
 				return view('loan365::welcomemsg.welcomeMsg',compact('value','fetchvalues'));
 				break;
    ...
    {
    	$inputArr     = $this->request->only('name','email','subject','body');
    	$messages     = array(
				            'name.required' => 'Please enter name address',
				            'email.required' => 'Please enter email address',
				            'subject.required' => 'Please enter subject address',
				            'body.required' => 'Please enter message address',
	            		);
	    $rules 		  = array(
    		...
    		<div style="width:590px; position:relative; margin:40px auto; padding-bottom:15px;">
       			<div style="width:100%; float:left; z-index:100; height:auto; min-height:200px; background:#FFF; position:relative; ">
			            ...
			            <tbody>
			                ...
			                <tr>
			                    <td style="border: 1px solid #D0D0D0;padding: 5px;">Name</td><td style="border: 1px solid #D0D0D0;padding: 5px;">' .$inputArr['name']. '</td>					
			                </tr>
			                 <tr>
			                    <td style="border: 1px solid #D0D0D0;padding: 5px;">Email</td><td style="border: 1px solid #D0D0D0;padding: 5px;">' .$inputArr['email']. '</td>					
			                </tr>
							<tr>
			                    <td style="border: 1px solid #D0D0D0;padding: 5px;">Message</td><td style="border: 1px solid #D0D0D0;padding: 5px;">' .$inputArr['body']. '</td>					
			                </tr>
			            </tbody>
			        </table>
