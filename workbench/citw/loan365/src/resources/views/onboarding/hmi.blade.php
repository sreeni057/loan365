        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="brand">
                        <h1 style="font-size: 40px">Your buy-to-let illustration</h1>
                        <h3 style="font-size: 12px">Based on what you've told us, this is what your mortgage may look like</h3>
                        <div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="nav nav-pills col-md-offset-2">
                                <li class="col-md-2">
                                    <a href="#personal" data-toggle="tab" aria-expanded="false">Yes</a>
                                </li>
                                <li class="active col-md-2">
                                    <a href="#developer" data-toggle="tab" aria-expanded="true">No</a>
                                </li>
                            </ul>
                        </div>
                    </div>
